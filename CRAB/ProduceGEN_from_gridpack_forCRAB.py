...
# with command line options: Configuration/GenProduction/python/SMP-RunIISummer20UL16wmLHEGEN-00496-fragment.py --python_filename SMP-RunIISummer20UL16wmLHEGEN-00496_1_cfg.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN,LHE --fileout file:SMP-RunIISummer20UL16wmLHEGEN-00496.root --conditions 106X_mcRun2_asymptotic_v13 --beamspot Realistic25ns13TeV2016Collision --customise_commands process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(100) --step LHE,GEN --geometry DB:Extended --era Run2_2016 --no_exec --mc -n 10
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/SMP-RunIISummer20UL16wmLHEGEN-00496-fragment.py nevts:10'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SMP-RunIISummer20UL16wmLHEGEN-00496.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SMP-RunIISummer20UL16wmLHEGEN-00496_inLHE.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc7_amd64_gcc10/13TeV/powheg/Vj_MiNNLO/Zj_slc7_amd64_gcc10_CMSSW_12_3_1_ZJToMuMu-suggested-nnpdf31-ncalls-doublefsr-q139-powheg-MiNNLO31-svn3900-ew-rwl6-j200-st2fix-ana-hoppetweights-ymax20.tgz'),
...
options.register('sampleType',
                  ...
                  "sampleType (e.g. DYMM_m10to50)")

options.parseArguments()

name_gridpack = "gridpack_MiNNLO_Powheg_%s.tgz" % options.sampleType
print "name_gridpack = %s" % name_gridpack

# -- gridpack path in a sandbox when it is run using CRAB
# -- only absolute path is recognizable in externalLHEProducer
path_gridpack = '/srv/%s' % name_gridpack
process.externalLHEProducer.args = cms.vstring(path_gridpack)
